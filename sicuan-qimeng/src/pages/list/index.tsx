...
class Page extends BasePage {
    ...
    load() {
        if (this.cokStatus.getCookie()) var memo: List.IMemo = Json.deSerializ(this.cokStatus.getCookie());
    ...
    openPrevious() {
        ...
        let source: List.ISource = Json.deSerializ(this.source.takeToLocal());
...
PageRegister(Page, {
    ...
    source: new PageSource(new Cookie(`${ConfigBasic.mainCookieName}_list_source`)),
    cokStatus: new Cookie(`${ConfigBasic.mainCookieName}_list_status`),
    // debugSystem:true,
    // debugOther:true
});