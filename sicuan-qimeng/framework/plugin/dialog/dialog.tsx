...
const txt_confirm = require("../../../src/assets/images/common/txt_confirm.png?raw");
const txt_cancel = require("../../../src/assets/images/common/txt_cancel.png?raw");
...
class DialogModule extends Component<IDialogProps, IDialogState>{
    ...
    constructor(props: IDialogProps) {
        ...
        this.props.super.target = (msg: string, index): Promise<{ status: boolean, keyCode: Key }> => {
            return new Promise((resolve, reject) => {
                this.resolve = resolve;

                if (undefined !== index) this.setIndex(index);
...
export class Dialog {
    ...
    target: (msg: string, index?) => Promise<{ status: boolean, keyCode: Key }>;
}